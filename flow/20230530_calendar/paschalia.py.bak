...
def get_day_details(cur_date):
    ...
    if cur_date < paschalia_dates[1]["lent_start"] or cur_date > paschalia_dates[1]["pentecost"]:
        ...
        weeks_till_lent = None if weeks_till_lent > 5 or weeks_till_lent < 0 else weeks_till_lent
...
if __name__ == "__main__":
    ...
    #print(get_day_details(datetime(2025,1,1),paschalia_dates))
    #print(get_day_details(datetime.now()))
    #print(get_week_code(datetime.now(),''))
    print(get_week_code(datetime(2025,4,27),''))
    pass